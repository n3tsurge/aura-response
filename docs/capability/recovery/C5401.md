...
| :--- | :--- | :--- |
| C5401-C5401-REQ-3 | Monitoring capabilities to detect any signs of threat persistence during recovery. | Monitoring|
| C5401-C5401-REQ-2 | Recovery procedures and backup systems available for restoration. | System|
| C5401-C5401-REQ-1 | Verified clean state of systems and data before restoration. | Validation|

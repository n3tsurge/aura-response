...
| :--- | :--- | :--- |
| C4502-C4502-REQ-1 | Complete understanding of threat scope and affected systems. | Knowledge|
| C4502-C4502-REQ-2 | Tools and access necessary to remove threats and restore system integrity. | System|
| C4502-C4502-REQ-4 | Administrative access and configuration management tools for system modifications. | System|
| C4502-C4502-REQ-3 | Validation methods to confirm complete threat removal. | Validation|

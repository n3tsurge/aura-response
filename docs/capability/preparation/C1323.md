...
| :--- | :--- | :--- |
| C1323-C1323-REQ-2 | Documented procedures and playbooks must be available for executing this capability. | Documentation|
| C1323-C1323-REQ-1 | Staff must be trained and qualified to perform this capability effectively. | Staffing|
| C1323-C1323-REQ-3 | File system access and forensic tools for file analysis and manipulation. | System|

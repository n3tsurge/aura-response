...
| :--- | :--- | :--- |
| C1318-C1318-REQ-2 | Documented procedures and playbooks must be available for executing this capability. | Documentation|
| C1318-C1318-REQ-1 | Staff must be trained and qualified to perform this capability effectively. | Staffing|
| C1318-C1318-REQ-3 | File system access and forensic tools for file analysis and manipulation. | System|

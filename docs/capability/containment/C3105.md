...
| :--- | :--- | :--- |
| C3105-C3105-REQ-1 | Authority and access permissions to implement containment measures. | Authorization|
| C3105-C3105-REQ-2 | Technical capability and tools to execute containment actions effectively. | System|
| C3105-C3105-REQ-4 | Network monitoring tools and access to network infrastructure for analysis and control. | System|
| C3105-C3105-REQ-3 | Procedures to validate containment effectiveness and monitor for bypass attempts. | Validation|
...
- [SentinelOne](../tool/sentinelone/C3105.md)

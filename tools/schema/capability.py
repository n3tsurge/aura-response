...
class Capability(BaseComponent):
    ...
    def generate_markdown(self) -> str:
        ...
        if self.phase:
            markdown_content += f"![](https://img.shields.io/badge/Phase-{self.phase_friendly_name.capitalize()}_%28{self.phase}%29-blue)&nbsp;![](https://img.shields.io/badge/Category-{self.category.capitalize()}-blue)\n"
